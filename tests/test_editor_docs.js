...
function runEditorDocsTests() {
    ...
    assert(html.includes('class="syn-command"') && html.includes('for</span>'), "'for' keyword should be highlighted as command");
    assert(html.includes('class="syn-command"') && html.includes('in</span>'), "'in' keyword should be highlighted as command");
    ...
    assert(html.includes('<span class="syn-punctuation">=</span>'), "'=' should be highlighted as punctuation");
