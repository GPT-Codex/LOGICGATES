 ...
 * @returns {string}
 */
export async function defaultFileResolver(module) {
    const response = await fetch('/api/import', {
        method: "POST",
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ file: module })
    });
 ...
 */
export async function processScriptImports(mainScriptText, mainFilePath = "main.sim", options = {}) {
    const fileResolver = options.fileResolver || ((path) => defaultFileResolver(path));
